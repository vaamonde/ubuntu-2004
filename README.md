# REPOSITÓRIO EM DESENVOLVIMENTO - SCRIPT's "FORKADO" DO REPOSITÓRIO DA VERSÃO 18.04.x LTS, TODOS OS SCRIPTS SERÃO ADAPTADOS PARA A VERSÃO DO UBUNTU 20.04.x LTS, NÃO SERÁ REGRAVADO OS VÍDEOS DOS SCRIPT NESSA VERSÃO, DEVIDO AO CONCEITO UTILIZADO NA VERSÃO 18.04.x SER IGUAL NESSA VERSÃO, SERÁ GRAVADO SOMENTE VÍDEOS E SOLUÇÕES/SERVIÇOS DE TI NOVOS USANDO A VERSÃO 20.04.x, EXEMPLO: FreeRADIUS, OnlyOffice Server, etc...
